...
fn it_gets_the_see_score() {
    ...
    assert_see_score(
        "4k2r/p1ppqpb1/bnr1p3/3PN1n1/1p2P1p1/2N2Q1p/PPPBBPPP/R3K2R w KQk - 0 1",
        "d5e6",
        0,
    );
    assert_see_score(
        "5k2/5p1p/p3B1p1/P5P1/3K1P1P/8/8/8 b - - 0 1",
        "f7e6",
        BISHOP_VALUE,
    );
    ...
    assert_see_score(
        "2rr3k/pp3pp1/1nnqbN1p/3pN3/1PpP4/2P3Q1/P1B4P/R4RK1 b - b3 0 1",
        "c4b3",
        0,
    );
    assert_see_score(
