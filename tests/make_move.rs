...
use rusty_rival::make_move::{default_position_history, get_move_index, make_move, unmake_move};
...
pub fn it_makes_a_move() {
    ...
    make_move(&mut position, move_from_algebraic_move("e2e3".to_string(), PIECE_MASK_PAWN), &mut history);
    ...
    let original_position = get_position(&"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1".to_string());
    let mut position = original_position.clone();
    make_move(&mut position, move_from_algebraic_move("e2e7".to_string(), PIECE_MASK_PAWN), &mut history);
    ...
    let mut position = original_position.clone();
    make_move(&mut position, move_from_algebraic_move("e1g1".to_string(), PIECE_MASK_KING), &mut history);
    ...
    let original_position = get_position(&"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQK2R w KQkq - 0 1".to_string());
    let mut position = original_position.clone();
    make_move(&mut position, move_from_algebraic_move("h1g1".to_string(), PIECE_MASK_ROOK), &mut history);
    ...
    let mut position = original_position.clone();
    make_move(&mut position, move_from_algebraic_move("e8c8".to_string(), PIECE_MASK_KING), &mut history);
    ...
    let original_position = get_position(&"r3k2r/pppppppp/2n1b3/2bn1q2/8/4P3/PPPP1PPP/RNBQK2R b KQq - 0 1".to_string());
    let mut position = original_position.clone();
    make_move(&mut position, move_from_algebraic_move("e8d8".to_string(), PIECE_MASK_KING), &mut history);
    ...
    let original_position = get_position(&"r3k2r/pppppppp/2n1b3/2bn1q2/8/4P3/PPPP1PPP/RNBQK2R b KQq - 0 1".to_string());
    let mut position = original_position.clone();
    make_move(&mut position, move_from_algebraic_move("h8g8".to_string(), PIECE_MASK_ROOK), &mut history);
    ...
    let mut position = original_position.clone();
    make_move(&mut position, move_from_algebraic_move("f4e3".to_string(), PIECE_MASK_PAWN), &mut history);
    ...
    let mut position = original_position.clone();
    make_move(&mut position, move_from_algebraic_move("g7h8r".to_string(), PIECE_MASK_PAWN), &mut history);
    ...
    let mut position = original_position.clone();
    make_move(&mut position, move_from_algebraic_move("g2g1q".to_string(), PIECE_MASK_PAWN), &mut history);
    ...
    let original_position = get_position(&"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1".to_string());
    let mut position = original_position.clone();
    make_move(&mut position, move_from_algebraic_move("e2e4".to_string(), PIECE_MASK_PAWN), &mut history);
    ...
    let mut position = original_position.clone();
    make_move(&mut position, move_from_algebraic_move("a7a6".to_string(), PIECE_MASK_PAWN), &mut history);
    ...
    let original_position = get_position(&"8/p7/8/1P6/K1k3pP/6P1/8/8 b - h3 0 1".to_string());
    let mut position = original_position.clone();
    make_move(&mut position, move_from_algebraic_move("a7a5".to_string(), PIECE_MASK_PAWN), &mut history);
    ...
    let original_position = get_position(&"8/p7/8/1P6/K1k3pP/6P1/8/8 b - h3 0 1".to_string());
    let mut position = original_position.clone();
    make_move(&mut position, move_from_algebraic_move("c4c5".to_string(), PIECE_MASK_KING), &mut history);
