...
fn it_calculates_the_null_move_reduced_depth() {
    ...
    assert_eq!(null_move_reduced_depth(4), 2);
    assert_eq!(null_move_reduced_depth(5), 3);
    assert_eq!(null_move_reduced_depth(6), 3);
    assert_eq!(null_move_reduced_depth(7), 4);
    assert_eq!(null_move_reduced_depth(8), 5);
    assert_eq!(null_move_reduced_depth(9), 6);
    assert_eq!(null_move_reduced_depth(10), 7);
    assert_eq!(null_move_reduced_depth(11), 8);
    assert_eq!(null_move_reduced_depth(12), 8);
    assert_eq!(null_move_reduced_depth(13), 9);
    assert_eq!(null_move_reduced_depth(14), 10);
    assert_eq!(null_move_reduced_depth(18), 13);
    assert_eq!(null_move_reduced_depth(24), 18);
}
