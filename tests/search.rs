...
fn it_returns_the_best_move_at_depth_1() {
    ...
    let position =
        get_position(&"n5k1/1P2P1n1/5q1p/P1pP4/5R2/5B2/1r2N2P/R3K1n1 w Q - 0 1".to_string());
...
fn it_returns_the_best_move_when_time_runs_out() {
    assert_move(
        "rnb1kbnr/pppppppp/8/2q4R/8/8/PPPPPPPP/RNBQKBN1 w Qkq - 0 1",
        20,
        100,
        "h5c5",
    );
...
fn it_gets_the_12_piece_index_for_a_move() {
    ...
    assert_eq!(
        ...
        piece_index_12(
            &position,
            hydrate_move_from_algebraic_move(&position, "c5d7".to_string())
        )
    );
    assert_eq!(
        0,
    ...
    assert_eq!(
        ...
        piece_index_12(
            &position,
            hydrate_move_from_algebraic_move(&position, "g4f2".to_string())
        )
    );
    assert_eq!(
        6,
        piece_index_12(
            &position,
            hydrate_move_from_algebraic_move(&position, "d6d5".to_string())
        )
    );
}
