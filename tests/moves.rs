...
pub fn it_checks_for_check() {
    ...
    assert_eq!(
        is_check(&get_position(&"3k4/8/6N1/4K3/8/8/8/8 b - - 0 1".to_string()), BLACK),
        false
    );
    assert_eq!(
        is_check(&get_position(&"8/3k4/6N1/4K3/8/8/8/8 b - - 0 1".to_string()), BLACK),
        false
    );
    assert_eq!(
        is_check(&get_position(&"8/5k2/6N1/4K3/8/8/8/8 b - - 0 1".to_string()), BLACK),
        false
    );
    ...
    assert_eq!(
        is_check(&get_position(&"r2k3r/p6p/8/B7/1p2p3/2pb4/P4K1P/R6R w - - 0 1".to_string()), BLACK),
        true
    );
}
