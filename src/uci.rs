...
pub fn run_command(
    ...
    match *parts.get(0).unwrap() {
        "bench" => cmd_benchmark(uci_state, search_state),
        "uci" => cmd_uci(),
        "isready" => cmd_isready(),
                ...
                if !moves.is_empty() {
                    for m in moves {
                        if !is_legal_move(&new_position, &m) {
                            return Left(
                                "Illegal move found".parse::<String>().unwrap() + " " + &*m,
                            );
                        }
                        let hydrated_move =
                            hydrate_move_from_algebraic_move(&position, m.to_string());
...
fn cmd_uci() -> Either<String, Option<String>> {
    Right(Some("id name Rusty Rival |20220401-06-IID-NullMoveReduce-2|\nid author Chris Moreton\noption name Clear Hash type button\nuciok".parse().unwrap()))
}
...
fn cmd_benchmark(
    ...
    let positions = vec![
        ...
        (
            "P3",
            "8/6nk/8/1p2P1Q1/1P4PP/P4q2/8/6K1 w - - 3 56",
            "h4h5",
            12,
        ),
        (
        ...
        (
            "Rusty4",
            "N7/8/2KQ2rp/6k1/3p3p/2p4P/4PP2/5N2 w - - 0 1",
            "a8c7",
            11,
        ),
        (
            "Passant",
            "rnbqkbnr/ppppp1pp/8/4P3/5pP1/8/PPPP1P1P/RNBQKBNR b QKqk g3 0 3",
            "d7d6",
            9,
        ),
        (
        ...
        (
            "Promote",
            "rnb1qbnr/pppPk1pp/8/8/8/8/PPPP1PPP/RNBQKBNR w QK - 1 5",
            "d7e8q",
            9,
        ),
        (
            "P5",
            "2r5/p2Qbkpp/4p3/5p2/2P4q/P2P2N1/1r3P1P/R3K2b w Q - 0 20",
            "g3h1",
            7,
        ),
        (
            "Ruy",
            "r1bqk2r/2pp1ppp/p1n2n2/1pb1p3/4P3/1B3N2/PPPP1PPP/RNBQ1RK1 w qk - 4 7",
            "d2d3",
            9,
        ),
        (
        ...
        (
            "P1",
            "r3kbnr/pp1qpppp/3pb3/8/3BP3/2NB1N2/PPP2PPP/R3K2R b QKqk - 4 8",
            "a7a6",
            9,
        ),
        (
            "Qc3 bad",
            "2r3k1/q4ppp/3p4/1r1Pp3/2n3P1/pN1R1P1P/P1P5/2KRQ3 w - - 8 1",
            "d3c3",
            11,
        ),
        (
            "B Prom",
            "2r5/Br4pp/1P1k4/3P1p2/1R1R1P2/p6P/1n3P2/6K1 w - - 2 35",
            "g1g2",
            12,
        ),
        (
            "Qa6 bad",
            "2r2rk1/p4ppp/2Q5/4b3/1q6/4P3/PP3PPP/R1B2K1R w - - 3 19",
            "c6a6",
            11,
        ),
        (
        ...
        (
            "Pawn Up",
            "6k1/6p1/1p2q2p/1p5P/1P3RP1/2PK1B2/1r2N3/8 b - g3 0 56",
            "e6d6",
            10,
        ),
        (
            "Heavy D",
            "4k3/1p3pp1/7p/1p6/1P2P2P/2PRKB2/4N1P1/2r1q3 b - - 0 40 ",
            "g7g5",
            10,
        ),
        (
            "P6",
            "r2r3k/5ppp/p7/3p4/P1pN1Nq1/5nPP/1PR5/4RK2 w - - 0 1",
            "h3g4",
            12,
        ),
        (
            "P7",
            "r1b4k/1p1n4/p7/3Q4/8/2qBB2P/PrP2PP1/b2R2RK w - - 9 6",
            "e3d4",
            7,
        ),
        ...
        (
            "P10",
            "rq3rk1/2bn1ppn/2p1p3/p2p2PR/P1PP4/N3B3/4PP2/R2QKB2 b Q - 0 21",
            "g7g6",
            8,
        ),
        (
            "P11",
            "r2r3k/5ppp/p7/Q2p4/P1pN1Nq1/5nPP/1PR5/4RK2 b - - 0 1",
            "g4g3",
            11,
        ),
        (
            "P12",
            "8/2pb4/4k3/5pp1/8/r4PbB/8/3R2K1 w - f6 0 35",
            "h3f5",
            11,
        ),
        (
            "P13",
            "8/p5pp/4pk2/5p2/1QP5/P7/5P1P/R3K2N b Q - 0 5",
            "g7g5",
            9,
        ),
        (
            "P14",
            "2r3k1/1rnq1pb1/2Rp1npp/1p1Pp3/1P2P3/3BBPPN/3Q2K1/4R3 b - - 3 1",
            "g6g5",
            9,
        ),
        (
            "P15",
            "r1b1kbnr/2ppqppp/p1n5/1p2p3/4P3/1B3N2/PPPP1PPP/RNBQK2R w QKqk - 2 6",
            "b1c3",
            9,
        ),
...
fn cmd_perft(depth: u8, uci_state: &UciState) -> Either<String, Option<String>> {
    ...
    println!(
        "{} nodes {} nps",
        nodes,
        (nodes as f64 / (duration.as_millis() as f64)) * 1000.0
    );
    Right(None)
}
