...
pub fn run_command_sync(uci_state: &mut UciState, search_state: &mut SearchState, l: &str) -> Either<String, Option<String>> {
    ...
    match *parts.first().unwrap() {
        ...
        "ucinewgame" => {
            ...
            search_state.children_by_kind = [0; 3];
            search_state.children_by_depth = [0; 5];
            ...
            search_state.lmr_eligible_by_kind = [0; 4];
            search_state.lmr_applied_by_kind = [0; 4];
            search_state.lmr_researched_by_kind = [0; 4];
            search_state.lmr_reduction_hist = [[0; 6]; 4];
            search_state.lmr_applied_early = [0; 4];
            search_state.lmr_history_sum = [0; 4];
            ...
            search_state.iir_reductions = 0;
            search_state.deep_nodes = 0;
...
fn cmd_go(
    ...
    for thread_id in 0..num_threads {
        ...
        thread_search_state.children_by_kind = [0; 3];
        thread_search_state.children_by_depth = [0; 5];
        ...
        thread_search_state.lmr_eligible_by_kind = [0; 4];
        thread_search_state.lmr_applied_by_kind = [0; 4];
        thread_search_state.lmr_researched_by_kind = [0; 4];
        thread_search_state.lmr_reduction_hist = [[0; 6]; 4];
        thread_search_state.lmr_applied_early = [0; 4];
        thread_search_state.lmr_history_sum = [0; 4];
        ...
        thread_search_state.iir_reductions = 0;
        thread_search_state.deep_nodes = 0;
