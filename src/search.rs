use crate::engine_constants::{
    ...
    LMR_CAPTURE_BASE, LMR_CAPTURE_HISTORY_DIVISOR, LMR_CUT_NODE_EXTRA, LMR_FROM_SECOND_MOVE, LMR_IN_CHECK, LMR_MIN_DEPTH, LMR_PV_FLAG,
            ...
            let (lmr, lmr_raw_hist, lmr_raw_r): (u8, i32, i32) = if lmr_considered {
                let (r, raw_hist): (i32, i32) = if is_tactical {
                    ...
                    let r = lmr_reduction(depth, searched_index.min(63) as u8) as i32
                        ...
                        + if cut_node { LMR_CUT_NODE_EXTRA } else { 0 } // expected cut node (NET-1276)
