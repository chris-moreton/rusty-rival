...
pub const WHITE_PAWN_MOVES_CAPTURE: [Bitboard; 64] = [
...
pub const BLACK_PAWN_MOVES_CAPTURE: [Bitboard; 64] = [
...
pub const WHITE_PAWN_MOVES_FORWARD: [Bitboard; 64] = [
...
pub const BLACK_PAWN_MOVES_FORWARD: [Bitboard; 64] = [
...
pub const PAWN_MOVES_FORWARD: [[Bitboard; 64]; 2] = [WHITE_PAWN_MOVES_FORWARD, BLACK_PAWN_MOVES_FORWARD];
pub const PAWN_MOVES_CAPTURE: [[Bitboard; 64]; 2] = [WHITE_PAWN_MOVES_CAPTURE, BLACK_PAWN_MOVES_CAPTURE];
pub const DOUBLE_MOVE_RANK_BITS: [Bitboard; 2] = [RANK_4_BITS, RANK_5_BITS];
pub const EN_PASSANT_CAPTURE_RANK: [Bitboard; 2] = [RANK_6_BITS, RANK_3_BITS];
...
pub const EMPTY_CASTLE_SQUARES: [[Bitboard; 2]; 2] = [[EMPTY_CASTLE_SQUARES_WHITE_KING, EMPTY_CASTLE_SQUARES_BLACK_KING], [EMPTY_CASTLE_SQUARES_WHITE_QUEEN, EMPTY_CASTLE_SQUARES_BLACK_QUEEN]];
pub const NO_CHECK_CASTLE_SQUARES: [[Bitboard; 2]; 2] = [[NO_CHECK_CASTLE_SQUARES_WHITE_KING, NO_CHECK_CASTLE_SQUARES_BLACK_KING],[NO_CHECK_CASTLE_SQUARES_WHITE_QUEEN, NO_CHECK_CASTLE_SQUARES_BLACK_QUEEN]];
