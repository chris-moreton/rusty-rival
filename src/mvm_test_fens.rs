...
pub fn get_test_fens() -> Vec<(&'static str, &'static str, Score, u32)> {
    vec![
        ...
        ("8/8/2p5/2P2kpp/4p2P/5PP1/5K2/8 b - - 0 43", "g5h4", 225, 250), // 250

        ("8/8/2p5/2P2k1p/4p2P/5P2/5K2/8 b - - 0 44", "f5f4", 250, 1000), // 1000
        ...
        ("8/6pk/2p5/2P4p/4p3/6PP/5PK1/8 b - - 0 40", "h7g6", 175, 1000), // 1000
