...
pub fn get_test_fens() -> Vec<(&'static str, &'static str)> {
    vec![
        ...
        ("3r1k2/3q1pp1/p2b1n2/1p1Pp3/5r1p/4RB1P/PPPNQ1P1/1K2R3 w - - 14 27", "d2e4"),
        ...
        ("2r3k1/5pp1/p4n2/1pbPpq2/2P2r1p/1P2RB1P/PK1NQ1P1/3R4 w - - 5 31", "f6e4"),
        ("2r3k1/5pp1/p4n2/1p1Ppq2/2Pb1rBp/1P2R2P/PK1NQ1P1/3R4 w - - 7 32", "b2b1"),
        ...
        ("5r1k/6n1/2p4p/1p6/pP1P1K2/P1N4P/8/3R4 w - - 1 42", "f4e5"),
