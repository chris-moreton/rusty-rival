...
pub const PIECE_MOVED_QUEEN_MASK: Move = 512;
pub const PIECE_MOVED_ROOK_MASK: Move = 1536;
pub const PIECE_MOVED_BISHOP_MASK: Move = 1024;
pub const PIECE_MOVED_KNIGHT_MASK: Move = 3072;
pub const PIECE_MOVED_PAWN_MASK: Move = 2560;
pub const PIECE_MOVED_KING_MASK: Move = 3584;
pub const PIECE_MOVED_FULL_MASK: Move = 3584;
