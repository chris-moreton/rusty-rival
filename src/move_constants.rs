use crate::bitboards::{
    bit, A1_BIT, A8_BIT, C1_BIT, C8_BIT, D1_BIT, D8_BIT, E1_BIT, E8_BIT, F1_BIT, F8_BIT, G1_BIT,
    G8_BIT, H1_BIT, H8_BIT,
};
use crate::hash::{ZOBRIST_KEYS_PIECES, ZOBRIST_PIECE_INDEX_KING, ZOBRIST_PIECE_INDEX_ROOK};
use crate::types::{Bitboard, Move, Mover, Square, BLACK, WHITE};
...
pub const PROMOTION_SQUARES: Bitboard =
    0b1111111100000000000000000000000000000000000000000000000011111111;
pub const KING_START_POSITIONS: Bitboard =
    0b0000100000000000000000000000000000000000000000000000000000001000;
pub const NON_PROMOTION_SQUARES: Bitboard =
    0b0000000011111111111111111111111111111111111111111111111100000000;
...
pub const CLEAR_CASTLE_FLAGS_MASK: [u8; 2] = [!(WK_CASTLE | WQ_CASTLE), !(BK_CASTLE | BQ_CASTLE)];

pub const START_POS: &str = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1";

pub const WHITE_KING_CASTLE_MOVE: Move =
    from_square_mask(3) | 1 | PIECE_MASK_KING | WHITE_KING_CASTLE_MOVE_MASK;
pub const WHITE_QUEEN_CASTLE_MOVE: Move =
    from_square_mask(3) | 5 | PIECE_MASK_KING | WHITE_QUEEN_CASTLE_MOVE_MASK;
pub const BLACK_KING_CASTLE_MOVE: Move =
    from_square_mask(59) | 57 | PIECE_MASK_KING | BLACK_KING_CASTLE_MOVE_MASK;
pub const BLACK_QUEEN_CASTLE_MOVE: Move =
    from_square_mask(59) | 61 | PIECE_MASK_KING | BLACK_QUEEN_CASTLE_MOVE_MASK;

pub const CASTLE_MOVE: [[Move; 2]; 2] = [
    [WHITE_KING_CASTLE_MOVE, BLACK_KING_CASTLE_MOVE],
    [WHITE_QUEEN_CASTLE_MOVE, BLACK_QUEEN_CASTLE_MOVE],
];
...
pub const ZOBRIST_KEYS_CASTLE_PIECE_MOVES: [u128; 4] = [
    ZOBRIST_KEYS_PIECES[WHITE as usize][ZOBRIST_PIECE_INDEX_KING][E1_BIT as usize]
        ^ ZOBRIST_KEYS_PIECES[WHITE as usize][ZOBRIST_PIECE_INDEX_KING][G1_BIT as usize]
        ^ ZOBRIST_KEYS_PIECES[WHITE as usize][ZOBRIST_PIECE_INDEX_ROOK][H1_BIT as usize]
        ^ ZOBRIST_KEYS_PIECES[WHITE as usize][ZOBRIST_PIECE_INDEX_ROOK][F1_BIT as usize],
    ZOBRIST_KEYS_PIECES[WHITE as usize][ZOBRIST_PIECE_INDEX_KING][E1_BIT as usize]
        ^ ZOBRIST_KEYS_PIECES[WHITE as usize][ZOBRIST_PIECE_INDEX_KING][C1_BIT as usize]
        ^ ZOBRIST_KEYS_PIECES[WHITE as usize][ZOBRIST_PIECE_INDEX_ROOK][A1_BIT as usize]
        ^ ZOBRIST_KEYS_PIECES[WHITE as usize][ZOBRIST_PIECE_INDEX_ROOK][D1_BIT as usize],
    ZOBRIST_KEYS_PIECES[BLACK as usize][ZOBRIST_PIECE_INDEX_KING][E8_BIT as usize]
        ^ ZOBRIST_KEYS_PIECES[BLACK as usize][ZOBRIST_PIECE_INDEX_KING][G8_BIT as usize]
        ^ ZOBRIST_KEYS_PIECES[BLACK as usize][ZOBRIST_PIECE_INDEX_ROOK][H8_BIT as usize]
        ^ ZOBRIST_KEYS_PIECES[BLACK as usize][ZOBRIST_PIECE_INDEX_ROOK][F8_BIT as usize],
    ZOBRIST_KEYS_PIECES[BLACK as usize][ZOBRIST_PIECE_INDEX_KING][E8_BIT as usize]
        ^ ZOBRIST_KEYS_PIECES[BLACK as usize][ZOBRIST_PIECE_INDEX_KING][C8_BIT as usize]
        ^ ZOBRIST_KEYS_PIECES[BLACK as usize][ZOBRIST_PIECE_INDEX_ROOK][A8_BIT as usize]
        ^ ZOBRIST_KEYS_PIECES[BLACK as usize][ZOBRIST_PIECE_INDEX_ROOK][D8_BIT as usize],
];

pub const CASTLE_VARS_KING_TO: [Square; 4] = [G1_BIT, C1_BIT, G8_BIT, C8_BIT];
...
pub const CASTLE_VARS_NEW_MOVER: [Mover; 4] = [BLACK, BLACK, WHITE, WHITE];

pub const CASTLE_VARS_FULL_MOVE_INC: [u16; 4] = [0, 0, 1, 1];
